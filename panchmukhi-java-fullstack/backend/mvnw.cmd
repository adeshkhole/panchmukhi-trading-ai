...
set MAKEN_PROJECTBASEDIR=%~dp0
set MAKEN_PROJECTBASEDIR=%MAKEN_PROJECTBASEDIR:~0,-1%

@REM Create .mvn/wrapper if it doesn't exist
if not exist "%MAKEN_PROJECTBASEDIR%\.mvn\wrapper" mkdir "%MAKEN_PROJECTBASEDIR%\.mvn\wrapper"

@REM Download maven-wrapper.jar if it doesn't exist
set WRAPPER_JAR="%MAKEN_PROJECTBASEDIR%\.mvn\wrapper\maven-wrapper.jar"
