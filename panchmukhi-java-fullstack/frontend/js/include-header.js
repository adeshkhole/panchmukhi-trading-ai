                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-3">
                                <a href="index.html" class="text-gray-300 hover:text-white hover:bg-gray-700 px-2.5 py-2 rounded-md text-sm font-medium transition-all nav-link" data-lang-key="dashboard">
                                    📊 Dashboard
                                </a>
                                <a href="news.html" class="text-gray-300 hover:text-white hover:bg-gray-700 px-2.5 py-2 rounded-md text-sm font-medium transition-all nav-link" data-lang-key="news">
                                    📰 News
                                </a>
                                <a href="sectors.html" class="text-gray-300 hover:text-white hover:bg-gray-700 px-2.5 py-2 rounded-md text-sm font-medium transition-all nav-link">
                                    🏢 Sectors
                                </a>
                                <a href="ipo.html" class="text-gray-300 hover:text-white hover:bg-gray-700 px-2.5 py-2 rounded-md text-sm font-medium transition-all nav-link" data-lang-key="ipo">
                                    💰 IPO
                                </a>
                                <a href="options.html" class="text-gray-300 hover:text-white hover:bg-gray-700 px-2.5 py-2 rounded-md text-sm font-medium transition-all nav-link" data-lang-key="options">
                                    📈 Options
                                </a>
                                <a href="isro.html" class="text-gray-300 hover:text-white hover:bg-gray-700 px-2.5 py-2 rounded-md text-sm font-medium transition-all nav-link" data-lang-key="satellite">
                                    🛰️ ISRO
                                </a>
                                <a href="scraper-admin.html" class="text-gray-300 hover:text-white hover:bg-gray-700 px-2.5 py-2 rounded-md text-sm font-medium transition-all nav-link">
                                    ⚙️ Scraper
                                </a>
                            </div>
                        </div>
